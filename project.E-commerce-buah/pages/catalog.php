 ...
 * Updated: Navbar redesign dengan div terpisah untuk tombol
 * ================================================
 */
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* KANAN: Greeting + Tombol Terpisah */
        .nav-right { 
            display: flex; 
            align-items: center; 
            gap: 1rem; 
        ...
        /* DIV KHUSUS TOMBOL - TIDAK AKAN TERPOTONG */
        .nav-buttons { 
            display: flex; 
            align-items: center; 
            gap: 0.5rem; 
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <!-- KANAN: Greeting + DIV KHUSUS TOMBOL -->
            <div class="nav-right">
                <span class="user-greeting">
                    Halo, <strong><?php echo htmlspecialchars($user['nama_lengkap']); ?></strong>
                </span>

                <!-- DIV TERPISAH UNTUK TOMBOL - ANTI OVERFLOW -->
                <div class="nav-buttons">
                    <?php if (isAdmin()): ?>
                        <a href="../admin/dashboard.php" class="nav-btn outline">⚙️ Dashboard</a>
                    <?php endif; ?>
                    
                    <!-- TOMBOL PESANAN SAYA - SEKARANG PASTI MUNCUL -->
                    <div><a href="my_orders.php" class="nav-btn outline">📋 Pesanan Saya</a></div>
    ...
    <div class="container">
        <div class="products-section">
            ...
            <div class="empty-state">
                ...
                <a href="catalog.php" class="nav-btn solid" style="display: inline-block;">Lihat Semua Produk</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
